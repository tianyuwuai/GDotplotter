...
###
print "\n\n Usage :  perl this_script querychr sbjctchr querygff1 objctgff2 blastm8 pos_or_order queryinitial sbjctinitial e-value score hitnumber \n\n";
...
my $figure_file = $ARGV[6].$ARGV[0].".v.".$ARGV[7].$ARGV[1].".blast2dotplot.png";
