...
###
print "\n\n Usage :  perl this_script querychr sbjctchr querygff1 objctgff2 mcscan_align pos_or_order queryinitial sbjctinitial score e-value length \n\n";
...
my $figure_file = $ARGV[6].$ARGV[0].".v.".$ARGV[7].$ARGV[1].".mcscan2dotplot.png";
